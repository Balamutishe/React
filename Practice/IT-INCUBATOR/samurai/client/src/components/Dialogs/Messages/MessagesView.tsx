...
import { useMutateMessageAdd, useMutateMessageDelete, useQueryGetAllMessages } from "../../../hooks/api";
import { setDeleteMessageId, setMessageText } from "../../../redux/DialogsSlice.ts";
		...
		switch (queryMessages.status) {
				case "error":
						return <div>
								...
								<button onClick={ () => queryMessages.refetch() }>Повторить запрос</button>
						</div>;
				case "success":
						return <Messages
							messages={ queryMessages.data } userId={ userId }
